...
export function pushLog(text, source, level) {
...
export function getRecentLogs(n, levels, sources) {
 ...
 */
export function wrapLogLine(s, indent) {
    const cols = process.stdout.columns || 80;
    if (visibleWidth(s) <= cols)
        return s;
    const lines = [];
    let cur = "";
    let w = 0;
