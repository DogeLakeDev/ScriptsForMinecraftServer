 ...
 *
 * This is the clean API that downstream callers (CLI commands,
 ...
 * - `ROOT` from runtime.ts describes the deployment root so callers
...
export { ROOT, isMonorepoLayout, isRuntimeInitialized, resolveServiceScript, resolveFetchModule, spawnService, spawnServiceSync, type ServiceId } from "./runtime.js";
