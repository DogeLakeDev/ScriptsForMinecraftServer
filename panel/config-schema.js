...
const SCHEMA = {
  ...
  'modules.json': {
    name: '功能模块开关',
    desc: '插件功能启用/禁用（修改后需重启服务器）',
    fields: [
      { key: 'modules.fly', label: '飞行区域', type: 'boolean' },
      { key: 'modules.creative', label: '创造区域', type: 'boolean' },
      { key: 'modules.survival', label: '生存区域（建议与上项同时开启，否则没必要开）', type: 'boolean' },
      { key: 'modules.peace', label: '和平模式', type: 'boolean' },
      { key: 'modules.inventory_switcher', label: '生成/创造背包切换', type: 'boolean' },
      { key: 'modules.afk', label: 'AFK 检测', type: 'boolean' },
      { key: 'modules.clean', label: '幽谷响子の掉落物清理', type: 'boolean' },
      { key: 'modules.qa', label: 'BAKA问答系统', type: 'boolean' },
      { key: 'modules.chat', label: '聊天系统', type: 'boolean' },
      { key: 'modules.coop', label: '合作社', type: 'boolean' },
      { key: 'modules.shop', label: '商城', type: 'boolean' },
      { key: 'modules.land', label: '土地系统', type: 'boolean' },
      { key: 'modules.holoprint', label: '全息投影(Perview)', type: 'boolean' },
      { key: 'modules.money', label: '经济系统', type: 'boolean' },
      { key: 'modules.tps', label: 'TPS 监视器', type: 'boolean' },
      { key: 'modules.online_time', label: '在线时长统计', type: 'boolean' },
      { key: 'modules.activity_log', label: '玩家行为日志', type: 'boolean' },
      { key: 'modules.scoreboard_sync', label: '计分板备份/恢复', type: 'boolean' },
      { key: 'modules.spawn_protect', label: '出生保护', type: 'boolean' },
      { key: 'modules.chat_sounds', label: '「咕咕嘎嘎」神秘聊天音效', type: 'boolean' },
      { key: 'modules.qq_bridge', label: 'QQ 桥接(OneBOT11)', type: 'boolean' },
    ],
  },
