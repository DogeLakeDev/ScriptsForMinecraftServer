...
const STEP_FIELDS = [
  ...
  // step 3: 模块选择
  [
    { id: 'ui.defaultModules', label: '默认启用模块', kind: 'multi', choices: ['money', 'chat', 'afk', 'shop', 'land', 'tps', 'online_time', 'activity_log', 'scoreboard_sync', 'spawn_protect', 'chat_sounds', 'holoprint', 'inventory_switcher', 'fly', 'creative', 'survival', 'peace', 'qa', 'clean'] },
