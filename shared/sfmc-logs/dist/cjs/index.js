...
function createFileSink(filePath, opts = {}) {
  ...
  function getStream() {
    ...
    if (mkdir) import_node_fs.default.mkdirSync(import_node_path.default.dirname(filePath), { recursive: true });
    stream = import_node_fs.default.createWriteStream(filePath, { flags, encoding: "utf-8" });
    stream.on("error", () => {
    });
    return stream;
  }
