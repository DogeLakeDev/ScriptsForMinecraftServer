...
export type LandErrorCode = "not_found" | "forbidden" | "already_deleted" | "invalid_request" | "invalid_target" | "invalid_role" | "overlap" | "land_limit" | "insufficient_funds" | "database_unavailable" | "version_conflict" | "transaction_failed" | "request_id_conflict";
/** 领地业务操作的通用响应壳 */
