...
export const en = {
  ...
  "help.ui": "UI Studio — visual editor for declarative UI",
  "ui.usage": "Usage: ui studio [module-dir] | ui stop",
  "ui.studio.started": "UI Studio started: {url}\nProject root: {dir}",
  "ui.studio.hint": "Press Ctrl+C to stop the server.",
  "ui.studio.already": "UI Studio is already running: {url}",
  "ui.studio.stopped": "UI Studio stopped.",
  "ui.studio.notRunning": "UI Studio is not running in this process.",
  "ui.studio.failed": "Failed to start UI Studio: {message}",
