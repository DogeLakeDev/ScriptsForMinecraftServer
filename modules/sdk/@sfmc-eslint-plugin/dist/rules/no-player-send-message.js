...
export const noPlayerSendMessage = createRule({
    ...
    meta: {
        ...
        messages: {
            useMsg: "勿直接调用 sendMessage()。请使用 Msg.info / Msg.success / Msg.error / Msg.warning / Msg.tips（@sfmc-bds/sdk/sapi/runtime）。",
        },
        schema: [],
    },
    defaultOptions: [],
    create(context) {
        return {
            CallExpression(node) {
                ...
                if (prop.type !== "Identifier" || prop.name !== "sendMessage")
                    return;
