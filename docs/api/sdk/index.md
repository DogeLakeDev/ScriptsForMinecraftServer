...
包名 `@sfmc-bds/sdk`。本文是**用法导读**；完整类型签名见 TypeDoc 生成的 [SDK 类型参考](https://github.com/DogeLakeDev/ScriptsForMinecraftServer/blob/main/docs/reference/index.md)（`npm run docs -- api`）。
