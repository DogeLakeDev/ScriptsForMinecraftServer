...
const DEFAULT_FIELD: Record<LandCapability, keyof LandPermissions> = {
  place: "allow_place", break: "allow_destroy", container: "open_container", door: "use_door", button: "use_button",
  redstone: "use_redstone", attack_entity: "attack_entity", interact_entity: "interact_entity", pickup_item: "pickup_item",
};
...
export function canManage(land: LandData, playerId: string, capability: "manage_members" | "manage_permissions" | "rename" | "transfer" | "delete"): boolean {
