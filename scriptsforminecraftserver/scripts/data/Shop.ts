...
// Use the raw data structure as-is — the ShopItemData is the innermost data field
export interface ShopRoot {
    name: string;
    type: "root";
    sell: boolean;
    image: string;
    data: (ShopGroup | ShopExam)[];
}
...
export const shopData: ShopRoot[] = [
    {
        "name": "买入",
        "type": "root",
        "sell": false,
