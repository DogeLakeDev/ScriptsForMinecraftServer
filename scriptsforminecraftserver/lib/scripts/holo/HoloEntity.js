    ...
    static updateProjection(projectionId, settings) {
        ...
        try {
            ...
            if (settings.scale !== undefined)
                entity.setDynamicProperty(DP_SCALE, settings.scale);
            if (settings.opacity !== undefined)
                entity.setDynamicProperty(DP_OPACITY, settings.opacity);
            if (settings.rotation !== undefined)
                entity.setDynamicProperty(DP_ROTATION, settings.rotation);
            if (settings.visible !== undefined)
                entity.setDynamicProperty(DP_VISIBLE, settings.visible);
            if (settings.layer !== undefined)
                entity.setDynamicProperty(DP_LAYER, settings.layer);
            if (settings.offsetX !== undefined)
                entity.setDynamicProperty(DP_OFFSET_X, settings.offsetX);
            if (settings.offsetY !== undefined)
                entity.setDynamicProperty(DP_OFFSET_Y, settings.offsetY);
            if (settings.offsetZ !== undefined)
                entity.setDynamicProperty(DP_OFFSET_Z, settings.offsetZ);
            return true;
        }
        catch (err) {
